...
echo ($nID == "") ? 'javascript:void(0)" style="color:gray; ' : "article.php?id={$nID}";
?>" class="prev text-center box-btn btn-size-mid">Předchozí</a>
                </div>
                <div class="col-sm-2">
                    <a href="discusion.php?id=<?php echo htmlentities($ArticleID) ?>" class="text-center box-btn btn-size-mid">Diskuze</a>
                </div>
                <div class="col-sm-2">
                    <a href="<?php 
